...
@st.cache_resource
def load_assets():
    vect = joblib.load("C:\\Users\\manim\\OneDrive\\Desktop\\project 5\\models\\tfidf_vectorizer.pkl")
    model = joblib.load("C:\\Users\\manim\\OneDrive\\Desktop\\project 5\\models\\logisticregression.pkl")
    le = joblib.load("C:\\Users\\manim\\OneDrive\\Desktop\\project 5\\models\\label_encoder.pkl")
    df = pd.read_csv("C:\\Users\\manim\\OneDrive\\Desktop\\project 5\\cleaned_reviews.csv")
